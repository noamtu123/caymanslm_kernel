...
then in OrangeFox: RAM‑boot the trial `boot-*.img` to confirm it boots, and flash
the AnyKernel3 zip. The zip swaps only the kernel and keeps your ramdisk, so one
